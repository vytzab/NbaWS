...
public class Menu {
	...
	public static void mainMenu() {
		...
		System.out.println("|-----------------------------------|");
		System.out.println("|1. View a player in the league.    |");
		System.out.println("|2. View all players in the league. |");
		System.out.println("|3. Add a player to the league.     |");
		System.out.println("|4. Remove a player from the league.|");
